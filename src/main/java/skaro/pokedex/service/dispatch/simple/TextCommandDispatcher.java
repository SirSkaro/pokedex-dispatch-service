...
public class TextCommandDispatcher implements Dispatcher {
	...
	public TextCommandDispatcher(WorkRequestRouter queueRegistrar, EventProcessor<DiscordTextEventMessage> processor, MessageReceiverHotStream<DiscordTextEventMessage> receiver, Scheduler scheduler) {
